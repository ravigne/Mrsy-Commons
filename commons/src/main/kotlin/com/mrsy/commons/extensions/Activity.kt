...
import com.mrsy.commons.databinding.DialogTitleBinding
...
import com.mrsy.commons.helpers.MyContentProvider.COL_LAST_UPDATED_TS
import com.mrsy.commons.helpers.MyContentProvider.MY_CONTENT_URI
import com.mrsy.commons.models.*
import com.mrsy.commons.views.MyTextView
import java.io.*
...
fun Activity.openPathIntent(
    ...
    ensureBackgroundThread {
        ...
        Intent().apply {
            ...
            if (applicationId == "com.mrsy.gallery" || applicationId == "com.mrsy.gallery.debug") {
