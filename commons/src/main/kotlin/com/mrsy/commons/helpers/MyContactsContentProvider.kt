package com.mrsy.commons.helpers
...
import com.mrsy.commons.extensions.getIntValue
import com.mrsy.commons.extensions.getStringValue
import com.mrsy.commons.models.PhoneNumber
import com.mrsy.commons.models.SimpleContact
import com.mrsy.commons.models.contacts.*
...
class MyContactsContentProvider {
    companion object {
        ...
        fun getSimpleContacts(context: Context, cursor: Cursor?): ArrayList<SimpleContact> {
            ...
            if (packageName != "com.mrsy.dialer" && packageName != "com.mrsy.smsmessenger" && packageName != "com.mrsy.calendar") {
                return contacts
            }
        ...
        fun getContacts(context: Context, cursor: Cursor?): ArrayList<Contact> {
            ...
            val packageName = context.packageName.removeSuffix(".debug")
            if (packageName != "com.mrsy.dialer" && packageName != "com.mrsy.smsmessenger" && packageName != "com.mrsy.calendar"
                && packageName != "com.mrsy.dialer.debug" && packageName != "com.mrsy.smsmessenger.debug" && packageName != "com.mrsy.calendar.debug") {
                return contacts
            }
