...
import com.mrsy.commons.asynctasks.CopyMoveTask
import com.mrsy.commons.compose.extensions.DEVELOPER_PLAY_STORE_URL
import com.mrsy.commons.dialogs.*
import com.mrsy.commons.dialogs.WritePermissionDialog.WritePermissionDialogMode
import com.mrsy.commons.extensions.*
import com.mrsy.commons.helpers.*
import com.mrsy.commons.interfaces.CopyMoveListener
...
abstract class BaseSimpleActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (!packageName.startsWith("com.mrsy.", true)) {
            if ((0..50).random() == 10 || baseConfig.appRunCount % 100 == 0) {
                val label = "You are using a fake version of the app."
    ...
    fun startCustomizationActivity() {
        if (!packageName.contains("mrsy", true)) {
    ...
    fun handleSAFDialog(path: String, callback: (success: Boolean) -> Unit): Boolean {
        hideKeyboard()
        return if (!packageName.startsWith("com.mrsy")) {
            callback(true)
            false
    ...
    private fun getExportSettingsFilename(): String {
        val appName = baseConfig.appId.removeSuffix(".debug").removeSuffix(".pro").removePrefix("com.mrsy.")
