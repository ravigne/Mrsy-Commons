...
import com.mrsy.commons.compose.extensions.onEventValue
import com.mrsy.commons.compose.screens.ManageBlockedNumbersScreen
import com.mrsy.commons.compose.theme.AppThemeSurface
import com.mrsy.commons.dialogs.AddOrEditBlockedNumberAlertDialog
import com.mrsy.commons.dialogs.ExportBlockedNumbersDialog
import com.mrsy.commons.dialogs.FilePickerDialog
...
class ManageBlockedNumbersActivity : BaseSimpleActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            val isDialer = remember {
                config.appId.startsWith("com.mrsy.remotedialer")
            }
    ...
    private fun maybeSetDefaultCallerIdApp() {
        if (isQPlus() && baseConfig.appId.startsWith("com.mrsy.remotedialer")) {
