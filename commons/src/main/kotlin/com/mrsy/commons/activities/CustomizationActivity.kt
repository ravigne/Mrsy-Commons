...
import com.mrsy.commons.databinding.ActivityCustomizationBinding
import com.mrsy.commons.dialogs.*
import com.mrsy.commons.extensions.*
import com.mrsy.commons.helpers.*
import com.mrsy.commons.helpers.MyContentProvider.COL_ACCENT_COLOR
import com.mrsy.commons.helpers.MyContentProvider.COL_APP_ICON_COLOR
import com.mrsy.commons.helpers.MyContentProvider.COL_BACKGROUND_COLOR
import com.mrsy.commons.helpers.MyContentProvider.COL_PRIMARY_COLOR
import com.mrsy.commons.helpers.MyContentProvider.COL_TEXT_COLOR
import com.mrsy.commons.helpers.MyContentProvider.COL_THEME_TYPE
import com.mrsy.commons.helpers.MyContentProvider.GLOBAL_THEME_CUSTOM
import com.mrsy.commons.helpers.MyContentProvider.GLOBAL_THEME_DISABLED
import com.mrsy.commons.helpers.MyContentProvider.GLOBAL_THEME_SYSTEM
import com.mrsy.commons.models.GlobalConfig
import com.mrsy.commons.models.MyTheme
import com.mrsy.commons.models.RadioItem
import com.mrsy.commons.models.isGlobalThemingEnabled
...
//        binding.applyToAll.setTextColor(primaryColor.getContrastColor())
        ...
        binding.customizationAppIconColorHolder.setOnClickListener {
            if (baseConfig.wasAppIconCustomizationWarningShown || !isProVersion()) {
                ...
                ConfirmationDialog(this, "", com.mrsy.strings.R.string.app_icon_color_warning_g, R.string.ok, 0) {
    ...
    private fun pickAppIconColor() {
        IconListDialog(
            ...
            descriptionId = com.mrsy.strings.R.string.app_icon_color_warning_g
    ...
    private fun applyToAll() {
        when {
            ...
            isPro() -> {
                ...
                ConfirmationDialog(this, "", com.mrsy.strings.R.string.global_theme_success_g, R.string.ok, 0) {
                    updateColorTheme(getCurrentThemeId())
                    saveChanges(false)
                }
            }
    ...
    private fun setupUseAccentColor() {
        binding.apply {
            ...
            customizationUseAccentColorFaq.setOnClickListener {
                ConfirmationDialog(this@CustomizationActivity, messageId = com.mrsy.strings.R.string.use_accent_color_summary, positive = com.mrsy.commons.R.string.ok, negative = 0) {}
            }
        }
    }
