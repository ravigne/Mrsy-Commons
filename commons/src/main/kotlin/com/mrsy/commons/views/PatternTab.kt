...
import com.mrsy.commons.databinding.TabPatternBinding
import com.mrsy.commons.extensions.getProperPrimaryColor
import com.mrsy.commons.extensions.getProperTextColor
import com.mrsy.commons.extensions.performHapticFeedback
import com.mrsy.commons.extensions.updateTextColors
import com.mrsy.commons.helpers.PROTECTION_PATTERN
import com.mrsy.commons.interfaces.BaseSecurityTab
import com.mrsy.commons.interfaces.HashListener
...
class PatternTab(context: Context, attrs: AttributeSet) : BaseSecurityTab(context, attrs) {
    ...
    override fun initTab(
        ...
        if (computedHash != "") binding.patternLockTitle.setText(com.mrsy.strings.R.string.enter_pattern)
    }
